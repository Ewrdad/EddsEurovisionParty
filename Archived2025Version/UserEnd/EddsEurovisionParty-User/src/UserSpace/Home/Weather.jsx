        ...
        <TooltipTrigger>
          ...
          <p className="text-slate-800 ">
            ...
            *C
            ...
            {weatherData.current &&
              Math.floor(weatherData.current.cloudCover)}% <CloudIcon />{" "}
            {weatherData.current &&
              Math.floor(weatherData.current.windSpeed10m)}
            km/h
            <AirIcon />{" "}
          </p>
        </TooltipTrigger>
        <TooltipContent className="bg-white/20 rounded-4xl">
          <p>Weather in Basel,Switzerland</p>
        </TooltipContent>
      </Tooltip>
    </TooltipProvider>
  );
