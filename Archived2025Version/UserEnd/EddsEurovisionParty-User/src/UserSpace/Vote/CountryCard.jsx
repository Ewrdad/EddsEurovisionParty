            ...
            <Grid container className="justify-center text-center">
              ...
              <Grid size={8} className="content-center">
                <Grid container className="justify-center text-center h-full">
                  <Grid size={12} className="content-center h-min p-1">
                    {country.dq && (
                      <h3 className="text-slate-200 text-xl bg-red-800 rounded-4xl w-full h-min p-2 font-bold">
                        Didn't Qualify
                      </h3>
                    )}
                  </Grid>
                ...
                <Grid size={12} className="content-center"></Grid>
              </Grid>{" "}
              <Grid
                size={12}
