    ...
    <Grid container className="justify-center text-center">
      ...
      <Grid size={11}>
        <div
          className={
            votesSum >= 20
              ? "bg-amber-400/75 rounded-4xl"
              : "bg-white/75 rounded-4xl"
          }
        >
      ...
      {!defaultVotes &&
        CountryList.map(() => (
          <Skeleton className="h-40 w-full animate-pulse rounded-md bg-muted bg-slate-700/40 ml-15 mr-15 mt-2 mb-2" />
        ))}
